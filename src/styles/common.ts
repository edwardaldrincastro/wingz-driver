...
export const halfWidth = { width: "50%" } as const;
...
export const borderBottomGray12 = { borderBottomWidth: 1, borderBottomColor: colorGray._12 } as const;
